        ...
        <div className="flex-1 flex items-center justify-center">
          ...
          {!authUser && (
            ...
            <Button
              ...
              variant="secondary"
              className="w-full text-lg sm:text-xl py-5 sm:py-6 min-h-[56px] shadow-md flex items-center justify-center gap-3 bg-[#FEE500] hover:bg-[#FDD835] text-[#000000] font-semibold"
            >
            ...
            <Button
              ...
              variant="secondary"
              className="w-full text-lg sm:text-xl py-5 sm:py-6 min-h-[56px] shadow-md flex items-center justify-center gap-3 bg-white hover:bg-gray-50 text-gray-700 font-semibold border border-gray-300"
            >
