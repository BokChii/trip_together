...
export const TutorialModal: React.FC<TutorialModalProps> = ({ open, onClose }) => {
  ...
  return (
    ...
    >
      <div
        className="bg-white rounded-2xl shadow-md border border-orange-100/50 max-w-md w-full sm:max-w-lg p-5 sm:p-6 max-h-[90vh] overflow-y-auto"
        ...
        {step === 0 && (
          <>
            <div className="flex items-center gap-3 mb-4">
              ...
              <h3 id="tutorial-title" className="text-lg sm:text-xl font-bold text-gray-800">
                언제갈래? 시작하기
              </h3>
            </div>
            <div className="mb-6">
